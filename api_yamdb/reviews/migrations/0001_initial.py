# Generated by Django 3.2 on 2023-07-15 08:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('moderator', 'Moderator'), ('admin', 'Admin')], max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(choices=[('1', 1), ('2', 2), ('10', 10)])),
        ...
        migrations.AddConstraint(
            model_name='review',
            constraint=models.UniqueConstraint(fields=('text', 'author'), name='unique_follow'),
        ),
    ]
